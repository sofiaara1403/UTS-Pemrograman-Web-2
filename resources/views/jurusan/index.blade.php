...
<div class="mb-3 d-flex gap-2">
    ...
    <a href="{{ route('jurusan.create') }}" class="btn btn-primary btn-soft">
        + Tambah Jurusan
    </a>

    <a href="{{ route('jurusan.export.excel') }}" class="btn btn-success">
        Export Excel
    </a>

    <a href="{{ route('jurusan.export.pdf') }}" class="btn btn-danger">
        Export PDF
</a>
